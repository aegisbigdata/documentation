...
![Upload Notebook](visualizer_screenshots/9.PNG)

## STEP 2 - Open the notebook

Once the notebook is present, click on it to open. You will see the following:

![Visualizer Initial State](visualizer_screenshots/1.PNG)
...
![First Cell Code](visualizer_screenshots/0.PNG)
...
![File Picker](visualizer_screenshots/2.PNG)

Once a file is open, a small preview in tabular format will be shown

![File Preview](visualizer_screenshots/3.PNG)
...
![Visualization Types](visualizer_screenshots/4.PNG)
...
![Parameters](visualizer_screenshots/5.PNG)

![Parameters Filled](visualizer_screenshots/6.PNG)
...
![Sample Scatter Plot](visualizer_screenshots/7.PNG)
...
![Clear Output](visualizer_screenshots/8.PNG)
